...
namespace Keycloak.AuthServices.Sdk.Kiota.Admin.Admin.Realms.Item.Users.Item.RoleMappings.Clients.Item.Composite {
    /// <summary>
    /// Builds and executes requests for operations under \admin\realms\{realm}\users\{user-id}\role-mappings\clients\{client}\composite
    /// </summary>
    public class CompositeRequestBuilder : BaseRequestBuilder {
        ...
        public CompositeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/realms/{realm}/users/{user%2Did}/role-mappings/clients/{client}/composite{?briefRepresentation*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="CompositeRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CompositeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/realms/{realm}/users/{user%2Did}/role-mappings/clients/{client}/composite{?briefRepresentation*}", rawUrl) {
        }
        /// <summary>
