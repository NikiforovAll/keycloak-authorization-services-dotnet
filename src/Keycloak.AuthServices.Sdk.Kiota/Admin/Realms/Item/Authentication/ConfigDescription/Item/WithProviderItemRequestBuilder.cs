...
namespace Keycloak.AuthServices.Sdk.Kiota.Admin.Admin.Realms.Item.Authentication.ConfigDescription.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Keycloak.AuthServices.Sdk.Kiota.Admin.Admin.Realms.Item.Authentication.ConfigDescription.Item.WithProviderItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Keycloak.AuthServices.Sdk.Kiota.Admin.Models.AuthenticatorConfigInfoRepresentation?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Keycloak.AuthServices.Sdk.Kiota.Admin.Models.AuthenticatorConfigInfoRepresentation> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<Keycloak.AuthServices.Sdk.Kiota.Admin.Models.AuthenticatorConfigInfoRepresentation>(requestInfo, Keycloak.AuthServices.Sdk.Kiota.Admin.Models.AuthenticatorConfigInfoRepresentation.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Get authenticator provider&apos;s configuration description
        /// </summary>
