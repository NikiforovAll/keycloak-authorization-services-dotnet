...
namespace Keycloak.AuthServices.Sdk.Kiota.Admin.Models
{
    ...
    public class ApplicationRepresentation : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The access property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_access? Access { get; set; }
#nullable restore
#else
        public Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_access Access { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_attributes? Attributes { get; set; }
#nullable restore
#else
        public Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_attributes Attributes { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_authenticationFlowBindingOverrides? AuthenticationFlowBindingOverrides { get; set; }
#nullable restore
#else
        public Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_authenticationFlowBindingOverrides AuthenticationFlowBindingOverrides { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_claims? Claims { get; set; }
#nullable restore
#else
        public Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_claims Claims { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_registeredNodes? RegisteredNodes { get; set; }
#nullable restore
#else
        public Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_registeredNodes RegisteredNodes { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "access", n => { Access = n.GetObjectValue<Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_access>(Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_access.CreateFromDiscriminatorValue); } },
                { "adminUrl", n => { AdminUrl = n.GetStringValue(); } },
                { "alwaysDisplayInConsole", n => { AlwaysDisplayInConsole = n.GetBoolValue(); } },
                { "attributes", n => { Attributes = n.GetObjectValue<Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_attributes>(Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_attributes.CreateFromDiscriminatorValue); } },
                { "authenticationFlowBindingOverrides", n => { AuthenticationFlowBindingOverrides = n.GetObjectValue<Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_authenticationFlowBindingOverrides>(Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_authenticationFlowBindingOverrides.CreateFromDiscriminatorValue); } },
                ...
                { "claims", n => { Claims = n.GetObjectValue<Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_claims>(Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_claims.CreateFromDiscriminatorValue); } },
                ...
                { "registeredNodes", n => { RegisteredNodes = n.GetObjectValue<Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_registeredNodes>(Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_registeredNodes.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_access>("access", Access);
            writer.WriteStringValue("adminUrl", AdminUrl);
            writer.WriteBoolValue("alwaysDisplayInConsole", AlwaysDisplayInConsole);
            writer.WriteObjectValue<Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_attributes>("attributes", Attributes);
            writer.WriteObjectValue<Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_authenticationFlowBindingOverrides>("authenticationFlowBindingOverrides", AuthenticationFlowBindingOverrides);
            ...
            writer.WriteObjectValue<Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_claims>("claims", Claims);
            ...
            writer.WriteObjectValue<Keycloak.AuthServices.Sdk.Kiota.Admin.Models.ApplicationRepresentation_registeredNodes>("registeredNodes", RegisteredNodes);
