...
using System;
namespace PhaseTwo.AuthServices.Sdk.Kiota.Admin.Admin.Orgs.Item.Members.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \{realm}\orgs\{orgId}\members\{userId}
    /// </summary>
    ...
    public partial class WithUserItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithUserItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/{realm}/orgs/{orgId}/members/{userId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="WithUserItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithUserItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/{realm}/orgs/{orgId}/members/{userId}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::PhaseTwo.AuthServices.Sdk.Kiota.Admin.Admin.Orgs.Item.Members.Item.WithUserItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::PhaseTwo.AuthServices.Sdk.Kiota.Admin.Admin.Orgs.Item.Members.Item.WithUserItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
