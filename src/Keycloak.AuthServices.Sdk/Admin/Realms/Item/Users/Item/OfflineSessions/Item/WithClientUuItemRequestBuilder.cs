...
using System;
namespace Keycloak.AuthServices.Sdk.Admin.Admin.Realms.Item.Users.Item.OfflineSessions.Item {
    /// <summary>
    ...
    public class WithClientUuItemRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new <see cref="WithClientUuItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<UserSessionRepresentation>?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<UserSessionRepresentation>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public WithClientUuItemRequestBuilder WithUrl(string rawUrl) {
            return new WithClientUuItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
