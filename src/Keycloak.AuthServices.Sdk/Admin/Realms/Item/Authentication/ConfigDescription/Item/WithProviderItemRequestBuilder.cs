...
using System;
namespace Keycloak.AuthServices.Sdk.Admin.Admin.Realms.Item.Authentication.ConfigDescription.Item {
    /// <summary>
...
#nullable enable
        public async Task<AuthenticatorConfigInfoRepresentation?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<AuthenticatorConfigInfoRepresentation> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<AuthenticatorConfigInfoRepresentation>(requestInfo, AuthenticatorConfigInfoRepresentation.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Get authenticator provider&apos;s configuration description
        /// </summary>
