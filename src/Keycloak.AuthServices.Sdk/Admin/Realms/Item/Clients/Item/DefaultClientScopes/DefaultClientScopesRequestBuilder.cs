// <auto-generated/>
using Keycloak.AuthServices.Sdk.Admin.Admin.Realms.Item.Clients.Item.DefaultClientScopes.Item;
...
using System;
namespace Keycloak.AuthServices.Sdk.Admin.Admin.Realms.Item.Clients.Item.DefaultClientScopes {
    /// <summary>
    ...
    public class DefaultClientScopesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Keycloak.AuthServices.Sdk.Admin.admin.realms.item.clients.item.defaultClientScopes.item collection</summary>
        ...
        /// <summary>
        /// Instantiates a new <see cref="DefaultClientScopesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="DefaultClientScopesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public DefaultClientScopesRequestBuilder WithUrl(string rawUrl) {
            return new DefaultClientScopesRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
