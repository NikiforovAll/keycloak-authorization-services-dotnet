...
#nullable enable
        public ApplicationRepresentation_access? Access { get; set; }
#nullable restore
#else
        public ApplicationRepresentation_access Access { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApplicationRepresentation_attributes? Attributes { get; set; }
#nullable restore
#else
        public ApplicationRepresentation_attributes Attributes { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApplicationRepresentation_authenticationFlowBindingOverrides? AuthenticationFlowBindingOverrides { get; set; }
#nullable restore
#else
        public ApplicationRepresentation_authenticationFlowBindingOverrides AuthenticationFlowBindingOverrides { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApplicationRepresentation_claims? Claims { get; set; }
#nullable restore
#else
        public ApplicationRepresentation_claims Claims { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApplicationRepresentation_registeredNodes? RegisteredNodes { get; set; }
#nullable restore
#else
        public ApplicationRepresentation_registeredNodes RegisteredNodes { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApplicationRepresentation"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApplicationRepresentation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApplicationRepresentation CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"access", n => { Access = n.GetObjectValue<ApplicationRepresentation_access>(ApplicationRepresentation_access.CreateFromDiscriminatorValue); } },
                {"adminUrl", n => { AdminUrl = n.GetStringValue(); } },
                {"alwaysDisplayInConsole", n => { AlwaysDisplayInConsole = n.GetBoolValue(); } },
                {"attributes", n => { Attributes = n.GetObjectValue<ApplicationRepresentation_attributes>(ApplicationRepresentation_attributes.CreateFromDiscriminatorValue); } },
                {"authenticationFlowBindingOverrides", n => { AuthenticationFlowBindingOverrides = n.GetObjectValue<ApplicationRepresentation_authenticationFlowBindingOverrides>(ApplicationRepresentation_authenticationFlowBindingOverrides.CreateFromDiscriminatorValue); } },
                ...
                {"claims", n => { Claims = n.GetObjectValue<ApplicationRepresentation_claims>(ApplicationRepresentation_claims.CreateFromDiscriminatorValue); } },
                ...
                {"registeredNodes", n => { RegisteredNodes = n.GetObjectValue<ApplicationRepresentation_registeredNodes>(ApplicationRepresentation_registeredNodes.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ApplicationRepresentation_access>("access", Access);
            writer.WriteStringValue("adminUrl", AdminUrl);
            writer.WriteBoolValue("alwaysDisplayInConsole", AlwaysDisplayInConsole);
            writer.WriteObjectValue<ApplicationRepresentation_attributes>("attributes", Attributes);
            writer.WriteObjectValue<ApplicationRepresentation_authenticationFlowBindingOverrides>("authenticationFlowBindingOverrides", AuthenticationFlowBindingOverrides);
            ...
            writer.WriteObjectValue<ApplicationRepresentation_claims>("claims", Claims);
            ...
            writer.WriteObjectValue<ApplicationRepresentation_registeredNodes>("registeredNodes", RegisteredNodes);
