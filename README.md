...
| `Keycloak.AuthServices.Authorization.TokenIntrospection` | [![Nuget](https://img.shields.io/nuget/v/Keycloak.AuthServices.Authorization.TokenIntrospection.svg)](https://nuget.org/packages/Keycloak.AuthServices.Authorization.TokenIntrospection) | Token introspection for lightweight access tokens (KC 24+) |
| `Keycloak.AuthServices.Authorization.Uma` | [![Nuget](https://img.shields.io/nuget/v/Keycloak.AuthServices.Authorization.Uma.svg)](https://nuget.org/packages/Keycloak.AuthServices.Authorization.Uma) | UMA 2.0 support — permission ticket challenges, RPT exchange |
